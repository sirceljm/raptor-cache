...
Cache.prototype = {
    ...
    get: function(key, options, callback) {
        ...
        if (typeof callback === 'function') {
            ...
            return util.callbackToPromise(this._getCallback, this, [key, options]);
        }
    },
    ...
    contains: function(key, options, callback) {
        ...
        if (typeof callback === 'function') {
            ...
            return util.callbackToPromise(this._containsCallback, this, [key, options]);
        }
    },
    ...
    flush: function(callback) {
        if (typeof callback === 'function') {
            ...
            return util.callbackToPromise(this._flushCallback, this, []);
        }
    },
