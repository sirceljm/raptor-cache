...
var CONTEXT_KEY = 'cacheManager';
var DEFAULT_CACHE_MANAGER;
...
var raptorCache = {
    ...
    createCacheManager: function(name, options) {
        var CacheManager = require('./CacheManager');
        return new CacheManager(name, options);
    },
    
    getDefaultCacheManager: function() {
        return DEFAULT_CACHE_MANAGER || (DEFAULT_CACHE_MANAGER = raptorCache.createCacheManager());
    }
};
